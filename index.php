    ...
    <div class="slider-banner-container">
      <div class="slider-banner-fullscreen">
        <ul class="slides">
          <!-- slide 1 start -->
          <!-- ================ -->
          <li data-transition="random-static" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Golfinhos">

          <!-- main image -->
          <img src="images/golfinhos.JPG" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
          ...
          <div class="tp-caption sfr stt xlarge_white"
            ...
            data-endelementdelay="0.1"
            data-splitout="chars"
            data-endspeed="400">Clima Tropical
          </div>
          ...
          <div class="tp-caption sft fadeout text-center large_white"
            ...
            data-easing="easeOutQuad"
            data-start="6400"
            data-end="10000"><span class="logo-font">Nossas <span class="text-default">Belezas...</span></span> <br> A natureza te espera
          </div>
          ...
          <!-- slide 2 start -->
          <!-- ================ -->
          <li data-transition="random-static" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Praias">

          <!-- main image -->
          <img src="images/catamara.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="media">
            ...
            <div class="media-body">
              <h4 class="media-heading">Lancha Poseidon</h4>
